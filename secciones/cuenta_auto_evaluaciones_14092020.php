...
<table width="100%" height="100%">
    <thead>
        <tr>
            ...
            <td><center><span class="campo1">Resultado de auto evaluación (Verde - todas las respuestas fueron NO / Rojo - alguna respuesta fue SI)</span></center></td>
    ...
    if($arrEntidades){
        foreach($arrEntidades as $i => $item){
            ...
            <tr class="<?=$class?> <?=((count($arrEntidades) - 1)==$i)?'tr-last':''?>">
                ...
                <td class="no_padding"><center><div style="width:30%; height:18px; background:<?=($item['status'] == 1) ? '#FF6A6A' : '#008000'?>">&nbsp</div></center></td>
