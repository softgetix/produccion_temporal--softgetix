  ...
  <div class="col-sm-8 conversation" id="chat_screen" style="display: none;">
      ...
      <div class="row reply" id="user_reply">
            ...
            <div class="col-sm-10 col-xs-10 reply-main">
              <textarea class="form-control disabled" rows="1" id="comment" ></textarea>
         ...
         getContacts();
          ...
          function getMessages(refresh = '')
          {
            ...
            if(name)
              ...
              if(refresh == 1){
                var dataString = {token:wati_token,url:wati_url,gmt:gmt,us_id:us_id,wp_number:wp_number,page_number:1,refresh:1,name:name};
              }else{
                var dataString = {token:wati_token,url:wati_url,us_id:us_id,gmt:gmt,wp_number:wp_number,page_number:page_number,refresh:0,name:name};
                if(page_number == 1){
              ...
              var extension = $(this).find('.extension').val();
               $.ajax({
                    url:'<?php echo base_url(); ?>WatiApi/getMedia',
                      type:'post',
                      data:{token:wati_token,url:wati_url,fileType:fileType,fileName:fileName,extension:extension},
                      dataType:'html',
                      success:function(data)
                      {
          ...
          function changeTicketStatus(){
            var id = $('.user_list_chatbox.active').attr('id');
            var contactDetailId = $('#'+id).find('.ContactDetail_id').val();
            var contact_number = $('#'+id).find('.wp_number').val();
...
function iamhere() {
 ...
 function sendMessageWithNumber(contact_number,user_name,send,template,templateName){
     ...
     var dataString = {token:wati_token,url:wati_url,us_id:us_id,phone:contact_number,messageText:messageText,template:template,templateName:templateName,user_name:user_name,templatesent:templatesent};
