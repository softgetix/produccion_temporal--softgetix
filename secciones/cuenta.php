<div id="main" class="sinColIzq">
	<div class="solapas gum clear">
    	<form name="frm_<?=$seccion?>" id="frm_<?=$seccion?>" action="?c=<?=$seccion?>&solapa=<?=$solapa?>" method="post">
            ...
            <?php }?>
            <?php if($objPerfil->validarSeccion('cuenta_moviles_semi')){?>
            <a class="izquierda float_l <?=($solapa=='moviles_semi')?'active':''?>" href="<?=$_SERVER['REDIRECT_URL'].'?c=cuenta&solapa=moviles_semi'?>">Tractor-Semi</a>
            <?php }?>
            <?php if($objPerfil->validarSeccion('cuenta_grupos_moviles')){?>
            <a class="izquierda float_l <?=($solapa=='grupos_moviles')?'active':''?>" href="<?=$_SERVER['REDIRECT_URL'].'?c=cuenta&solapa=grupos_moviles'?>"><?=$lang->menu->abmGrupoMoviles?></a>
            <?php }?>
            ...
            <?php }?>
            <?php if($objPerfil->validarSeccion('cuenta_referencias')){?>
            <a class="izquierda float_l <?=($solapa=='referencias')?'active':''?>" href="<?=$_SERVER['REDIRECT_URL'].'?c=cuenta&solapa=referencias'?>"><?=$lang->menu->abmReferencias?></a>
            <?php }?>
			...
			<?php }?>
            <?php if($objPerfil->validarSeccion('cuenta_auto_evaluaciones')){?>
            <a class="izquierda float_l <?=($solapa=='auto_evaluaciones')?'active':''?>" href="<?=$_SERVER['REDIRECT_URL'].'?c=cuenta&solapa=auto_evaluaciones'?>">Auto evaluaciones</a>
			<?php }?>
