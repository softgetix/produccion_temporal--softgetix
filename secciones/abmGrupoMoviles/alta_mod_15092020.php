<div id="mainBoxAM">
	...
	<fieldset>		
		...
		<table>
            ...
            <tr>
				<td style="height:25px; line-height:25px; text-align:center"><strong><?=$lang->system->moviles?></strong></td>
				<td></td>
				<td style="text-align:center"><strong><?=$lang->system->moviles_asignados?></strong></td>
			</tr>
			<tr>
				<td align="center" style="vertical-align:top; width:270px;">
                	<select name="cmbGrupos" id="cmbGrupos" style="width: 210px; margin:0px 0px 2px 0px; clear:both;" onChange='simple_ajax("ajaxObtenerMovilesGrupos.php?idGrupo=" + this.value + "&p=0");'>
                    ...
                    <select size="10" name="cmbMoviles" multiple="multiple" id="cmbMoviles"  style="width: 210px;">
					</select>
				</td>
				...
				<td align="center" style="width:270px;">
					<select name="cmbMovilesAsignados[]" multiple="multiple" id="cmbMovilesAsignados" style="width: 210px; height:186px;">
