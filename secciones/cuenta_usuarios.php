	...
	case 'modificar':?>
        ...
        <script language="javascript">
            $(document).ready(function(){
                simple_ajax('ajaxCompletarUserData.php?action=ocultar&perfil='+<?=$arrEntidades[0]['us_pe_id']?>);
            });
        </script>
        ...
        <br />
        <?php if($arrMoviles || $arrMovilesUsuario || tienePerfil(5) ){?>
        <fieldset>
        ...
        <thead>
            <tr>
                <td><span class="campo1"><?=$lang->system->nombre_apellido?></span></td>
                    <?php if(!tienePerfil(array(32,33,36))){?>
			...
			<?php }?>
                ...
                <?php if(tienePerfil(array(5,9,13,19,29,37))){?>
