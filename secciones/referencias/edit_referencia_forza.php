...
<input type="hidden" name="cmbGrupo" value="120">
...
<div id="infoPtos" class="claseInfoPunto">
    <div id="botonesABM">
		<a id="botonVolver" href="<?=($popup)?'javascript:;':('boot.php?c='.$seccion.(!empty($solapa)?('&solapa='.$solapa):''))?>"><img alt="" src="imagenes/botonVolver.png"><?=$lang->botonera->volver?></a>
	</div>
	...
	<fieldset>
        <label for="txtIdentClient">CUIT</label>
        <input type="text" name="txtIdentClient" id="txtIdentClient" value="<?=isset($_POST['txtIdentClient'])?$_POST['txtIdentClient']:$arrEntidades[0]['re_identificador']?>"  style="width:200px;" size=100>
        <span>&nbsp;&nbsp;</span>
	</fieldset>  
	...
	<fieldset>
        <label for="txtWhatsapps">Whatsapp</label>
	...
	<fieldset>
        ...
        <label for="re_papel" style="display: contents;">Requiere Original</label>
        <span>&nbsp;&nbsp;</span>
	</fieldset>
