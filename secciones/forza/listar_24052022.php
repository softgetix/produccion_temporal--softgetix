...
<table width="100%" height="100%">
	<tbody>
		...
		<?php if($type == 'entregas'){?>
		    ...
		    <a class="float_l margin_l button <?=($active_btn == 1) ? 'colorin':''?>" style="margin-top:5px;" onclick="javascript:enviar('filtroFecha','ultimo_mes');" href="javascript:;">Con Documento</a>
                    <a class="float_l margin_l button <?=($active_btn == 2) ? 'colorin':''?>" style="margin-top:5px;" onclick="javascript:enviar('filtroFecha','hoy');" href="javascript:;">Sin Documento</a>
