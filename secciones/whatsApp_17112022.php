  ...
  <div class="col-sm-8 conversation" id="chat_screen" style="display: none;">
   <div class="col-md-12">
    <div class="container" style="position:fixed;z-index: 99;padding-left: 0;">
     <div class="" id="preview_containter" style="display: none;width:65%; height:479px;background: #e8edef;border: 1px solid #00aa88; position:relative;transition: visibility .5s, opacity 0.5s linear;box-shadow: 0 0 10px #00aa88;padding: 10px;">
