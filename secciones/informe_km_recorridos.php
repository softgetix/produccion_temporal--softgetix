<div style="height:100%" class="contenido clear"> 
	...
	<fieldset style="width:350px; margin:20px 0 0 50px;">
    	<?php 
			...
			$msg = str_replace('[SOLAPA]', $lang->system->km_recorridos, $msg);
        ...
        <p><?=$msg?>.</p>
        <br /><br />
    	<a href="javascript:;" onclick="javascript:generarInforme('export_km_recorridos_xls')" style="width:200px;" class="button_xls exp_excel">
