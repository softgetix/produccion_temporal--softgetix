            ...
            <div style="height:100%" class="contenido flaps clear"> 
                ...
                <div id="buscador" class="no_padding margin_l" style="magin-botom:10px;">
                    ...
                    <select name="diasFiltro"  class="buscar" style="float:left; margin-right:10px;">
                        ...
                        <option value="1" <?=($_POST['diasFiltro'] == 1) ? 'selected="selected"':''?> >1 día</option>
                        <option value="7" <?=($_POST['diasFiltro'] == 7) ? 'selected="selected"':''?> >7 días</option>
                        <option value="14" <?=($_POST['diasFiltro'] == 14) ? 'selected="selected"':''?>>14 días</option>
                    </select>
