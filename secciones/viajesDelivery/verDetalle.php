...
<tbody>
	<tr>
        ...
        <div class="solapas gum clear" style="overflow:hidden;"><!-- height:92%;-->
            ...
            <a href="javascript:getContenido('seguridad')" class="izquierda float_l tipo-seguridad">Seguridad</a>
            ...
            <div id="viajes-listado" class="contenido clear" style="height:100%; <?=(!empty($_POST['hidSolapa']) && $_POST['hidSolapa']!='listado')?'display:none':''?>">
                ...
                <?if(tienePerfil(5)){?>
                <a href="javascript:;" onclick="javascript:deleteViaje()" class="button colorRed gum float_r" style="width:173px; margin-top:4px;"><?=$lang->botonera->eliminar?></a>
                <? }?>    
                <fieldset class="float_l">
                    <fieldset class="float_l clear margin_l">
                        ...
                        <?php if(!tienePerfil(88)){?>
                            <p><strong><?=$lang->system->rutaviaje?>: </strong><span><?=encode($datosViaje['vt_nombre'])?></span></p>
                ...
                <thead>
                	<tr>
                        ...
                        <td colspan="2">
                        	<span class="campo1"><?=$lang->system->movilsemi?></span>
                            <br />
                            <span class="campo2"><?=$lang->system->conductor?></span>
                        </td>
                        <td>
                        	<span class="campo1"><?=$lang->system->rutaviaje?></span>
                            <br />
                        ...
                        <td>
                            ...
                            <center><span class="campo2"></span></center>
                        </td>
                        <td>
                ...
                <tbody>
                    ...
                    <tr <?=empty($row['vdd_delivery'])?'class="refencia-origen"':''?> class="<?=(!$verContenido)?'destinos_'.$row['vd_id'].' row_viajes':''?>" <?php if(!$verContenido){?>style="display:none" <?php }?>>
                        ...
                        <td>
                        	<a href="javascript:;" class="float_r <?=($_SESSION['idEmpresa'] == 4835 || $_SESSION['idAgente'] == 4835) ? 'setNewcarArauco' : 'setNewcar' ?> <?=$first?'firts':''?>" title="<?=$lang->system->asignar_conductor_movil?>"
                        ...
                        <td>
                            ...
                            <span class="campo2">
                                ...
                                <?php if($row['vd_orden'] > 0 && 1==2 && $id_movil && (!empty($row['fecha_ini_real']) || (empty($row['fecha_ini_real']) && strtotime($row['fecha_ini']) < strtotime(getFechaServer()))) && $row['re_id'] > 0 && $row['re_id'] != 6464 && $box_date != $id_movil.$row['vd_re_id'] && empty($row['vd_pod_manual'])){?>
            ...
            <!-- Fin. POD -->
            <!-- Ini. Seguridad -->
            <div id="viajes-seguridad" class="contenido clear" style="height:100%; display:none">
				<table class="listado-viajes bottom-rows">
                <thead>
                	<tr>
                    	<td width="150"><span class="campo1"><center><?=$lang->system->fecha?></span></center></td>
                ...
                <tr><td colspan="3"><center>No se registran datos de Seguridad</center></td></tr>
                <?php }?>
				</tbody>
                </table>
			</div>
