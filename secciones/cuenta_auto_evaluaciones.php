...
<table width="100%" height="100%">
    <thead>
        <tr>
            ...
            <td><center><span class="campo1">Grupo</span></center></td>
            <td class="td-last"><center><span class="campo1">Resultado de &uacuteltima auto evaluaci&oacuten - 24 horas<br>(Verde - todas las respuestas fueron NO / Rojo - al menos una respuesta fue SI / Amarillo - No contest&oacute en las &uacuteltimas 24 horas. )</span></center></td>
    ...
    if($arrEntidades){
        ...
        foreach($arrEntidades as $i => $item){
            ...
            <tr class="<?=$class?> <?=((count($arrEntidades) - 1)==$i)?'tr-last':''?>">
                ...
                <td><center><?=$item['group']?></center></td>
