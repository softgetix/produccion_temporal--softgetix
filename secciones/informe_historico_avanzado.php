<div style="height:100%" class="contenido clear"> 
	<?php $objInformes->vistaListadoMoviles($arrMovilesUsuario, false);?>
	<fieldset style="width:350px; margin:20px 0 0 50px;">
    	<?php 
			$msg = $lang->message->msj_export_informes_avanzado; 
			$msg = str_replace('[SOLAPA]', $lang->system->historico_avanzado, $msg);
        ...
        <p><?=$msg?>.</p>
        <br /><br />
    	<a href="javascript:;" onclick="javascript:generarInforme('export_historico_avanzado_xls')" style="width:200px;" class="button_xls exp_excel">
