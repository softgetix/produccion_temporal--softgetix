<style>
 ...
 /*  // select {width:200px;max-width: 100%;}*/
    ...
    #main_tbl  thead,  tbody tr {
      display: table;
      width: 100%;
      table-layout: fixed;
    }
    /*#s_trip_code {width: 29%};*/
    ...
    #detalle-modal table tbody td{
      ...
      #detalle-modal  table thead, table  tbody tr {
      display: table;
      width: 100%;
      table-layout: fixed;
    }
    ...
    @media only screen and (min-width : 320px) and (max-width : 480px) {
            ...
            .w-40 select{width: 100% !important;}

          #main_tbl table, thead, tbody, th, td, tr {
                display: block;
              }
         ...
         #main_tbl td:before {
           ...
           #main_tbl td:nth-of-type(5):before { content: "";}
              ...
              #detalle-modal table, thead, tbody, th, td, tr {
                  display: block;
              }
             /* #detalle-modal table tbody td {
                  height: 11px;
...
/*              #detalle-modal tr { border: 1px solid white; }
*/              #detalle-modal td {
        ...
        <div class="contenido clear">
            ...
            <form name="frm_<?=$seccion?>" id="frm_<?=$seccion?>" action="?c=<?=$seccion?>" method="post">
                 <div class="w-30">
                  ...
                  <div class="w-40">
                        <select id="origin" name="origin_id" class="float_l">
                          ...
                          <select id="route" name="route_id" class="float_l"> 
                 ...
                 <div>  
                    <a class="button buscar" style="margin-top:0px" href="javascript:void('0');"><?=$lang->botonera->buscar?></a>
                ...
                success:function(result){
                    ...
                    if(result.Semi){
                        ...
                        for(var i=0;i<result.Semi.length;i++){
                            html += "<option value="+result.Semi[i].second_vehicle_id+">"+result.Semi[i].second_vehicle+"</option>";
                        }
                    ...
                    if(result.Configuracion){
                        ...
                        for(var i=0;i<result.Configuracion.length;i++){
                            html += "<option value="+result.Configuracion[i].configuration_id+">"+result.Configuracion[i].configuration_description+"</option>";
                        }
                    ...
                    if(result.Cargabruta){
                        ...
                        for(var i=0;i<result.Cargabruta.length;i++){
                            html += "<option value="+result.Cargabruta[i].load_id+">"+result.Cargabruta[i].load_description+"</option>";
                        }
                    ...
                    if(result.Tara){
                        ...
                        for(var i=0;i<result.Tara.length;i++){
                            html += "<option value="+result.Tara[i].tara_id+">"+result.Tara[i].tara_description+"</option>";
                        }
