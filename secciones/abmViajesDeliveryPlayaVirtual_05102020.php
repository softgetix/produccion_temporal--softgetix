			 ...
			 <?php } else {?> <center><span class="campo1">Chofer</span></center>
				...
				<?php } else {?> <center><span class="campo1">Arribo</span></center>
				 <?php } ?>		
                            ...
                            <td width="34" <?=tienePerfil(8) ? 'class="td-last"' : ''?>>
                            ...
                            <td width="44" class="td-last">
                                <center><span class="campo1">Confirmado</span></center>
							</td>
                           <?php }?>
                        </tr>
                    </thead>
						...
						?>	
							<tr class="<?=$fila?>">
                                ...
                                <td style="<?=$colorcelda?>">
                                    ...
                                    <span class="campo2"><?=$row['estadoplanificado']?></span>
                                    <?php }?>
                                    </center>
                                </td>
                                <td style="<?=$colorcelda?>">
                                ...
                                <td style="<?=$colorcelda?>" <?=tienePerfil(8) ? 'class="td-last"' : ''?>>
                                ...
                                <td style="<?=$colorcelda?>" class="td-last">
                                    <center>
                                        <input type="checkbox" name="confirmado" class="pv_facturado" <?=$row['vi_facturado']?'checked="checked"':''?> href="javascript:;" attrIdViaje="<?=$row['vi_id']?>" attrFacturado="<?=$row['vi_facturado']?>">
                                    </center>            
                                </td>
                                <?php }?>
                            </tr>
