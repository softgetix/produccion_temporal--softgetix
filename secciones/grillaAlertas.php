<?php if($_GET['googleMaps']){
    ...
    <a href="https://www.google.com/maps?q=<?=$_GET['lat']?>,<?=$_GET['lon']?>" class="f-left" target="_blank"  style="margin:4px;">Google Maps</a>
    <a href="javascript:cerrarPopup();" class="f-right" style="margin:4px;">Cerrar</a>
    <div id="mapa"></div>
    <script language="javascript">
        ...
        $( document ).ready(function() {
            ...
            arr['lat'] = lat;
            arr['lng'] = lng;
            arr['icono'] = '../imagenes/location-pin.png';
...
<form name="frm_<?=$seccion?>" id="frm_<?=$seccion?>" action="?c=<?=$seccion?>" method="post">
   ...
   <div id="mainBoxLI">
    <div id="Filtro" style="margin: 10px 0 0 20px;">
        ...
        <select name="idevento" id="idevento" onChange="javascript:getAlertas()" >
            <option value="">Selecione</option>
            <option value="1">Detenido + 60 minutos fuera de zonas autorizadas</option>
