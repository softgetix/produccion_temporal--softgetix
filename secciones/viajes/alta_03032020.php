...
<?php $banAgente = array(12481,17925)?>
	...
	<tbody>
    	<tr>
        	<td style="padding:10px;">
            	<?php if($tieneMovilAsignado){?>
					...
					<?php if($idViaje){ ?>									
					    <a href="javascript:;" class="button colorin" style="width:173px;"
                            onclick="javascript:
                                <?=(in_array($_SESSION['idAgente'], $banAgente) ? 'enviar(\'guardarM\')':'agregarMotivoCambio('.$idViaje.')')?>"                            
                ...
                <?php if(in_array($_SESSION['idAgente'], $banAgente)){?>
                    <fieldset class="gum_top2" id="fieldValidarCodigo">
