        ...
        <span class="clear" style="margin-bottom:4px;"></span>
         <div class="contenido clear" style="max-height:310px; overflow-x:auto;">
            ...
            <?php } elseif($vista == 'attachfile'){?>
                ...
                <?php }?>
            <?php } elseif($vista == 'authorize_entry'){?>
                <input name="idviaje" type="hidden" value="<?=$_GET['idviaje']?>" />
                <input name="iddestino" type="hidden" value="<?=$_GET['iddestino']?>" />
                <div style="padding:10px" <?=(!$status) ?'class="error"':'class="ok"'?> ><?=$message?></div>
                <?php if($status != true){?>
                <table>
                <tbody>
                    <tr><td><span class="campo2">Autorizar el ingreso a:</span></td></tr>
                    <tr><td>
                        <select name="autorizar_ingreso" style="width:100%;">
                            <?php foreach($pr_playa_virtual_mensajes as $popup_item){?>
                                <option value="<?=$popup_item['value']?>"><?=$popup_item['value']?></option>
                            <?php }?>
                        </select>   
                    </td></tr>
                </tdbody>
                ...
                <br/>
                <center><a href="javascript:enviar('popupPostAuthorizeEntry');" class="button colorin">Autorizar</a></center>
                <?php }?>
            <?php } else{?>
            	...
            	<div class="contenido clear" style="height:100%">
                    ...
                    <thead>
                        <tr>
			                ...
			                <?php } else {?> 
                                <center><span class="campo1">Transporte</span></center>
				            <?php } ?>
							</td>
							<td colspan="2">
			                <?php if(!tienePerfil(8)){?>
                			 ...
                			 <?php } else {?> 
                                <center><span class="campo1">Conductor</br>Patente / semi</span></center>
				             <?php } ?>
            			    </td>
							<td>
                              	<center><span class="campo1">Planta</br>Fecha de Carga</span></center>
                            </td>
							<td width="220">
            				
                                <center><span class="campo1">Fecha registraci&oacute;n</span></center>
				            	
							</td>
                            <td>
                                <? //=$objFiltroCol->label($col['numerodt'],'Ticket','campo1',true)?>
                                <center><span class="campo1">Ticket</span></center>
							</td>
							<?php /*if(!tienePerfil(8)){?>
                            <td>
                                <center><span class="campo1">Ingreso a Planta</span></center>
							</td>
                            <?php }*/?>
                            <td width="34">
                            ...
                            <?php if(!tienePerfil(8)){?>
                                <td width="34">
                                <center><span class="campo1">Ingreso</span></center>
							</td>
                            <td width="34" class="td-last">
						...
						?>	
							<tr class="<?=$fila?>">
                                ...
                                <td style="<?=$colorcelda?>">
                                    ...
                                    <?php if(!empty($row['estadoplanificado'])){?>
                                    <span class="campo2 color_rojo"><?=$row['estadoplanificado']?></span>
                                    <?php }?>
                                    </center>
                                </td>
                                <td style="<?=$colorcelda?>">
                                ...
                                <td style="<?=$colorcelda?>">
                                    ...
                                    <?php /*if(!tienePerfil(8)){?>
				<td style="<?=$colorcelda?>">
                                    <a title="Enviar autorizaci&oacute;n" class="float_l pv_send_message margin_l" href="javascript:;" attrIdViaje="<?=$row['vi_id']?>" style="margin-top:4px;">
                                        <span class="sprite sendmessage no_margin"></span>
                                    </a>
					<a title="Ver autorizaciones" class="float_l pv_view_history margin_l" href="javascript:;" attrIdViaje="<?=$row['vi_id']?>" style="margin-top:4px;">
                                ...
                                <td style="<?=$colorcelda?>">
                                    <a title="Información adicional" class="float_l pv_view_info_aditional margin_l" href="javascript:;" attrIdViaje="<?=$row['vi_id']?>" style="margin-top:4px;">
                                       <img src="imagenes/info.png" width="25" height="25" style="margin-top:4px;"/>                                     </a>
                                </td>
                                <?php if(!tienePerfil(8)){?>
                                <td style="<?=$colorcelda?>">
                                    <a title="Autorizar Ingreso" class="float_l pv_authorize_entry margin_l" href="javascript:;" attrIdViaje="<?=$row['vi_id']?>" attrIdDestino="<?=$row['re_id']?>" style="margin-top:4px;">
<img src="imagenes/whatsapp_icon.png" width="30" height="30" style="margin-top:4px;"/>                                      
