	...
	<nav class="navbar navbar-expand-md bg-white">
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navigation">
				...
				<li class="nav-item">
			            <a class="nav-link" href="https://www.avantiequipo.com/paquetes.html">Precio</a>
			          </li>
				<li class="nav-item">
...
<body>
	...
	<div style="height: 100%; top:0px; max-width:100%">
		<fieldset style="width:90%; position: absolute; top: 50%; left: 50%; -moz-transform: translateX(-50%) translateY(-50%); -webkit-transform: translateX(-50%) translateY(-50%); transform: translateX(-50%) translateY(-50%);">
			<center><label id="mobil">Abre <strong>avantiequipo.com</strong><br> en tu cumputadora para ingresar al tablero Web.</label></center>
		</fieldset>
	</div>
	<?php }
	else{?>
