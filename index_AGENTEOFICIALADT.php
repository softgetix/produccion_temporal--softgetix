	...
	<style>
		...
		h2{color:#355a9d; font-size:40px; font-weight: 600; text-transform:none; border:none; letter-spacing: 0px;}
...
<body>
	...
	<fieldset id="block_left">
		<div id="contenido">
			<img src="<?=$url.'/imagenes/img-clientes/logo_agentes_adt2.jpg'?>" />
			<br><br>
