...
function uploadExcel($objSQLServer, $seccion){
			...
			case UPLOAD_ERR_OK:
				...
				if ($extens != 'xls' && $extens != 'xlsx'){
					...
					switch($_SESSION['idEmpresa']){
						case 12481://--Prod
						//case 17925://--Testing
							$resultado = $objViaje->importarExcel_MSC($_FILES['archivo']);
						break;
						default:
							$resultado = $objViaje->Importar_Excel_SAP($_FILES['archivo']);
						break;
					}
	...
	index($objSQLServer, $seccion, $msj, $popup);
}
?>