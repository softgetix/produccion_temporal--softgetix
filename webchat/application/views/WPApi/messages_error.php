<?php //echo '<pre>';print_r($new_message_status);echo '</pre>'; ?>
                        ...
                        <div class="sender">
                            ...
                            <?php
                              ...
                              <div class="message-media page-<?php echo $page_number; ?>">
                                ...
                                ?>
                                 <input type="hidden" name="extension" class="extension" value="<?php echo $extension ?>">
                              ...
                              <?php
                                ...
                                <div class="message-media hasNoFile page-<?php echo $page_number; ?>">
                                  ...
                                  <?php 
                                    ...
                                    //$url_components = parse_url($fileurl);
                                    //parse_str($url_components['query'], $params); 
                                    $extension = pathinfo($item->text, PATHINFO_EXTENSION);

                                  ?>
                                  <input type="hidden" name="extension"  class="extension" value="<?php echo $extension ?>">
                                  <input type="hidden" class="wati_media" value="<?php echo $item->text ?>"> 
                                  <input type="hidden" name="filename" class="wati_media_filetype" value="<?php echo $item->type ?>">   
                                    <span class="media_file"></span>
                                </div>
                              <?php }    
