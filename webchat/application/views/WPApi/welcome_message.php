<!DOCTYPE html>
<html class="no-js" dir="ltr" loc="en-GB">
<head>
    <meta charset="utf-8">
...
<style type="text/css">
  ...
  html,body,div { height: 100%;  width: 100%; padding: 0;  margin: 0;  box-sizing: border-box; }
  body { /*background: url("http://shurl.esy.es/y") no-repeat fixed center;*/background-size: cover;font-family: initial;}
...
@media screen and (max-width: 700px) {
  ...
  .head-user-icon {padding-top: 15px !important;}
   #ticket_status_combobox {margin-top: 7px;}
}
...
.head-user-icon {margin-top: -15px;}
 ...
 -->
  ...
  <div class="col-sm-8 conversation" id="chat_screen" style="display: none;">
       <div class="row heading" id="user_detail">
            ...
            <div class="col-sm-1 col-md-1 col-xs-1" id="back" style="display: none;top:7px;font-size: 25px;padding: 0;color: white;">
              <i class="fa fa-arrow-left"  aria-hidden="true"></i>
            </div>
  ...
  <div class="col-sm-8 conversation" id="user_detail_info" style="display: none;">
     ...
     <div class="col-sm-8 conversation" id="blank_screen">
      <center><h1 style="margin-top: 250px;">Para comenzar por favor seleccione un chat</h1></center>
     </div>
	...
	$(document).ready(function(){
         ...
         getContacts();
          ...
          function getMessages(refresh = '')
          {
            ...
            var objHeight = objDiv.scrollHeight; //204;
            $(".heading-name-meta").html(name);
            if(name)
              $(".head-user-icon span").text(name.slice(0,1));
              
              if(refresh == 1){
                var dataString = {gmt:gmt,wp_number:wp_number,page_number:1};
              }else{
                var dataString = {gmt:gmt,wp_number:wp_number,page_number:page_number};
              }
                  ...
                  url:'<?php echo base_url(); ?>WatiApi/getMessages',
                    ...
                    { 
                      ...
                      { 
                        ...
                        $('#chat_box .page-1 .message-text').closest('.message-body').remove();
         ...
         // }  
          ...
          $('#chat_box').on('scroll', function() {
            ...
            if(div.scrollTop  == 0) {
               ...
               if(Math.round(total_pages/10) <= total_pages){
                page_number++;
                getMessages();
