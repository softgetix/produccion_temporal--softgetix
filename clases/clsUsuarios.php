...
class Usuario extends Abm{	
	...
	function obtenerUsuarios($id=0,$filtro="", $nombreUsuario="", $empresa=0){
		...
		$sql="SELECT ".$selectTop." us_id, us_nombreUsuario,us_pasaporte,us_zona,us_grupo,us_region, us_nombre, us_apellido, us_mailContacto, us_mailAlertas, us_telefono, us_expira,us_cant_fallido,us_ultimo_acceso, us_acceso_fallido,	us_celular, us_nextel, us_pe_id, us_cl_id, us_usuarioCreador, us_fechaCreado, pe_nombre, cl_razonSocial,
	...
	function obtenerUsuariosListado($datos){
		...
		$sql.= " AND cl_id_distribuidor = 74 and cl_paquete in (31,1) and cl_habilitado = 1 ";


		}

		if ( $_SESSION['idPerfil'] == 29) {
		$sql.= " AND cl_paquete = 26 ";
