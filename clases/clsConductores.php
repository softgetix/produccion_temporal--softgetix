...
class Conductor extends Abm{	
   ...
   function obtenerConductores($id=0, $filtro=""){
		...
		$strSQL = " SELECT ".$selectTop." co.*, ''  as co_Estado_app,  cl.cl_razonSocial as razon_social ";
		$strSQL.= " ,mo1.mo_".$vistaMovil." as movil_1, mo2.mo_".$vistaMovil." as movil_2, co_Verificado ";
