...
class Referencia extends Abm{
    ...
    function obtenerReferenciasEmpresa($idEmpresa = 0, $tipoAlerta = 0) {
    ...
    function obtenerReferenciasPorEmpresa2($idEmpresa = 0, $filtro =  NULL, $idModifica = NULL) {
		...
		$sql.= " tr_id, tr.tr_nombre , re.re_id ,re.re_nombre ,re.re_ubicacion, rg.rg_nombre, re.re_numboca, pr_nombre, lo_nombre ";
