...
<body>
	...
	<div style="height: 100%; top:0px; max-width:100%">
		<fieldset style="width:90%; position: absolute; top: 50%; left: 50%; -moz-transform: translateX(-50%) translateY(-50%); -webkit-transform: translateX(-50%) translateY(-50%); transform: translateX(-50%) translateY(-50%);">
			<center><label id="mobil">Abre <strong>login.avantiequipo.com</strong> en tu cumputadora para acceder a tu cuenta.<br><br>para volver a la Web <a href="https://www.avantiequipo.com/"><strong> Click aqu&iacute;</strong></a></label></center>
		</fieldset>
	</div>
	<?php }
	else{?>
