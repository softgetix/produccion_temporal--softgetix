$(document).ready(function(){
	...
	$('.reactivar_movil').live("click", function(){
		var idmovil = $(this).attr('attrIdMovil');
		var matricula = $(this).attr('attrMoMatricula'); 
		mostrarPopup('boot.php?c=cuenta&solapa=moviles&action=reactivar_movil&idmovil='+idmovil+'&matricula='+matricula,300,100);
	});
});
