...
function reloadComboTransportista(){
	...
	if($(selectdefault).val() != 'true'){//--No conservar primer opción del combo "Seleccione" cundo se define que seleccione por defecto el primer transportista
	...
	if($(selectdefault).val() == 'true'){//--Al selecciona por defecto la primera opción del combo, se recarga los demás combos.
...
function reloadComboConductor(id_transportista){
	...
	if($(selectdefault).val() != 'true'){//--No conservar primer opción del combo "Seleccione" cundo se define que seleccione por defecto el primer conductor
		$(ideCombo).append('<option value="" class="placeholder">'+txtSelect+'</option>');
	}
