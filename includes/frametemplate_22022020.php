...
<?php 	} ?>
	...
	if(!isset($sinDefaultJS)){ ?>
    	<script type="text/javascript" src="js/<?=$seccion?>Funciones.js"></script>
    <?php }?>
...
<?php		}
	...
	<body id="cuerpo" style="background:none;">
        ...
        <div id="wrapper">
        <div id="content">
        <!-- style="<?php if (isset($_GET["action"]) && $_GET["action"] == 'popup') echo 'height:500px !important'; ?>-->
		<!-- <div id="content" style="<?php if (isset($_GET["popupRastreo"])) echo 'height:500px !important';?>"> -->
			<?php 
            if($seccion == 'verificarEquipo'){ ?>
