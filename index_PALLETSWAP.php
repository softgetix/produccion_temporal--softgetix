	...
	?>
	<link href="https://redpalletswap.com/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
	<link href="https://redpalletswap.com/style.css" rel="stylesheet" type="text/css" />
	<!--<script type="text/javascript" src="https://redpalletswap.com/assets/js/jquery.min.js"></script>-->
	<!--<script type="text/javascript" src="https://redpalletswap.com/assets/js/bootstrap.min.js"></script> -->
	<nav class="navbar navbar-expand-md bg-white">
		<div class="container">
			<a class="navbar-brand" href="https://www.redpalletswap.com">
				<img src="https://redpalletswap.com/assets/images/PalletSwapLogoColor.svg"  alt="Logo" class="logo-regular" style="height:50px;width:158px;">
				<img src="https://redpalletswap.com/assets/images/PalletSwapLogoBlanco.svg" alt="Logo" class="logo-white" style="height:50px;width:158px;">
			</a>
			...
			<div class="collapse navbar-collapse" id="navigation">
				...
				<li class="nav-item">
					<a class="nav-link" href="https://www.redpalletswap.com">Home</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="https://www.redpalletswap.com/caracteristicas.html">Características</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="https://www.redpalletswap.com/solicitar-reunion.html">Solicitar reunión</a>
				</li>
				<li class="nav-item">
	...
	<style>
		...
		.no_tiene_cuenta{color:#ffffff; font-size:14px; font-weight: normal; letter-spacing: 0px;}
		.no_tiene_cuenta:hover{color:#ffffff !important; text-decoration: underline;}
...
<body>
	...
	<div style="height: 100%; top:0px; max-width:100%">
		<fieldset style="width:90%; position: absolute; top: 50%; left: 50%; -moz-transform: translateX(-50%) translateY(-50%); -webkit-transform: translateX(-50%) translateY(-50%); transform: translateX(-50%) translateY(-50%);">
			<center><label id="mobil">Abre <strong>redpalletswap.com</strong> en tu cumputadora<br>para comenzar a usar tu Acceso Web.</label></center>
		</fieldset>
	</div>
	<?php }
	else{?>
	<div id="contenido">	
		<form id="login_form" method="POST"> 
			...
			<fieldset>
				<br>
				<a href="https://www.redpalletswap.com/registrarse.html" target="_blank" class="no_tiene_cuenta">¿No tienes cuenta? Regístrate Aquí</a>
		 		<div class="clear"></div>
	 		</fieldset>
		</form>
